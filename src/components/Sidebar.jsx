...
function Sidebar() {
  ...
  return (
    <div className="px-6 w-[28%] h-[calc(100vh-6.625rem)] overflow-y-scroll overflow-x-hidden custom-scrollbar ">
      {/* Home */}
        ...
        {sidebarItems.map((item) => {
          return (
            ...
            >
              ...
              <span className="cursor-pointer font-semibold">{item.name}</span>
            </div>
          );
        })}
      </div>
        ...
        {sidebarItems4.map((item) => {
          return (
            <div
              ...
              className="flex items-center space-x-6 hover:bg-gray-300 duration-300 rounded-xl p-1"
            >
              <div className="text-2xl cursor-pointer text-red-500">
                {item.icon}
              </div>
              <span className="cursor-pointer font-semibold">{item.name}</span>
            </div>
